...
#  Default: False
c.AnnouncementService.allow_origin = True
...
c.AnnouncementService.cookie_secret_file = '/usr/local/lib/python3.8/dist-packages/jupyterhub_announcement/jupyterhub-announcement-cookie-secret'
...
# c.AnnouncementService.log_level = 50
...
#  Default: []
# c.AnnouncementService.template_paths = ["/usr/local/share/jupyterhub/templates","/usr/local/share/jupyterhub/announcement/templates"]
