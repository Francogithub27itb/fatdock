    ...
    def copy_files(self):
        ...
        for file_name in src_files:
            ...
            try:
                ...
                if stat.S_ISSOCK(os.stat(full_file_name).st_mode):
                    print(f"Skipping socket file: {file_name}")
                    continue
                ...
                print(f"File not found and skipped: {full_file_name}")
            except PermissionError:
                print(f"Permission denied and skipped: {full_file_name}")        
